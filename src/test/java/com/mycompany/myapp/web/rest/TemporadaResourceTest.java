...
public class TemporadaResourceTest {
    ...
    public void initTest() {
        ...
        temporada.setFecha(DEFAULT_FECHA);
    }
    ...
    public void createTemporada() throws Exception {
        ...
        assertThat(testTemporada.getFecha()).isEqualTo(DEFAULT_FECHA);
    }
    ...
    public void updateTemporada() throws Exception {
        ...
        temporada.setFecha(UPDATED_FECHA);
        ...
        assertThat(testTemporada.getFecha()).isEqualTo(UPDATED_FECHA);
    }
